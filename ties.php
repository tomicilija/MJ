...
<?php
    ...
    $london =  $article->getEdition('London', 0);
    $rome =  $article->getEdition('Rome', 0);
    $barcelona =  $article->getEdition('Barcelona', 0);
    $berlin =  $article->getEdition('Berlin', 0);
    $paris =  $article->getEdition('Paris', 0);
    $lisbon =  $article->getEdition('Lisbon', 0);
    $milano =  $article->getEdition('Milano', 0);
                ...
                <div class="prdt-top">
                    <div class="col-md-9 prdt-left">
                        <div class="sekcija" id="e1">
                            <h1>London Edition</h1>
                            <div class="product"> 
                                    <div class="container">
                                            <div class="product-top">
                                                <?php 
                                                    $st = 1;
                                                    foreach($london as $row)
                                                    {
                                                ?>
                        ...
                        <div class="sekcija" id="e3">
                            <h1>Barcelona Edition</h1>
                            <div class="product"> 
                                    <div class="container">
                                            <div class="product-top">
                                                <?php 
                                                    $st = 1;
                                                    foreach($barcelona as $row)
                                                    {
                                                ?>
                                                <div class="product-one">
                                                <div class="col-md-3 product-left" id="c<?php echo $st; $st++;?>">
                        ...
                        <div class="sekcija" id="e6">
                            <h1>Lisbon Edition</h1>
                            <div class="product"> 
                                    <div class="container">
                                            <div class="product-top">
                                                <?php 
                                                    $st = 1;
                                                    foreach($lisbon as $row)
                                                    {
                                                ?>
                                                <div class="product-one">
                                                <div class="col-md-3 product-left" id="c<?php echo $st; $st++;?>">
                            ...
                            <section  class="sky-form ">
                                ...
                                <div class="row1 scroll-pane">
                                    ...
                                    <div class="col col-4">	
                                        ...
                                        <label class="checkbox"><input onclick="myFunction(true)" type="checkbox" name="edition3" id="fe1" ><i></i>London Edition</label>	
                                        <label class="checkbox"><input onclick="myFunction(true)" type="checkbox" name="edition2" id="fe2" ><i></i>Rome Edition</label>	
                                        <label class="checkbox"><input onclick="myFunction(true)" type="checkbox" name="edition4" id="fe3" ><i></i>Barcelona Edition</label>	
                                        <label class="checkbox"><input onclick="myFunction(true)" type="checkbox" name="edition1" id="fe4" ><i></i>Berlin Edition</label>
                                        <label class="checkbox"><input onclick="myFunction(true)" type="checkbox" name="edition1" id="fe5" ><i></i>Paris Edition</label>
                                        <label class="checkbox"><input onclick="myFunction(true)" type="checkbox" name="edition1" id="fe6" ><i></i>Lisbon Edition</label>
                                        <label class="checkbox"><input onclick="myFunction(true)" type="checkbox" name="edition1" id="fe7" ><i></i>Milano Edition</label>
                                    </div>
                                </div>
                            </section>
                            <section  class="sky-form">
...
function myFunction(bol) {
    ...
    var x4 = document.getElementById("e4");
    var x5 = document.getElementById("e5");
    var x6 = document.getElementById("e6");
    var x7 = document.getElementById("e7");
    ...
    var fe4 = document.getElementById("fe4").checked;
    var fe5 = document.getElementById("fe5").checked;
    var fe6 = document.getElementById("fe6").checked;
    var fe7 = document.getElementById("fe7").checked;
    
    if ((fe1||fe2||fe3||fe4||fe5||fe6||fe7)&&bol) {    
    ...
    document.getElementById("fe4").checked = false; 
    document.getElementById("fe5").checked = false; 
